class ending1 extends Phaser.Scene{
  ...
  create(){
    ...
    this.enemySoul = this.physics.add.sprite(200, 650, "bran").setDepth(2.5).setScale(1.5).play("branIdle").setVelocityY(-20);
    this.enemy.play("branHang");
    this.enemySoul.alpha = .4;
    ...
    this.text = this.add.text(295, 40, "You went to Barnacle Town after killing Mad Hat\nand became the new sheriff.", {fontFamily: "litebulb", color: "black", fontSize: "19px"}).setDepth(999).setScrollFactor(0);
    ...
    this.music = this.sound.add("ending1", {volume: 0});
